...
sequelize = new Sequelize("nodejs","root","mmsPNMonl1n3",{
	host: "localhost",
	port : 3307
}),
url=require('url'),
...
var jaminan1bpkb = sequelize.define("jaminan1bpkb",{url:Sequelize.STRING,pic:Sequelize.STRING,packagetype:Sequelize.STRING,description:Sequelize.STRING,expdate:Sequelize.DATE});
isexist = function(){
	return false;
}
app.get('/',function(req,res){
	jaminan1bpkb.findAll().then(function(obj){
		...
		res.render("home.html",{title:"WebDev App",username:"Dude",jaminan1bpkb:obj});
	});
});
